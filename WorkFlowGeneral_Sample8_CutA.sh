...
export WORKINGDIR=/Users/yvans/Home/Analysis/BRCA_analysis_07.05.2012/Sample_Diag-HaloBRCA1A-test-8/Analysis_CutA/

# Are the reads from the default location or not? Should I passe dit by absolute path??
export READS1=/Users/yvans/Home/Analysis/BRCA_analysis_07.05.2012/Sample_Diag-HaloBRCA1A-test-8/Diag-HaloBRCA1A-test-8_ACTTGA_L004_R1_001.pf.clipped_m20.fastq
export READS2=/Users/yvans/Home/Analysis/BRCA_analysis_07.05.2012/Sample_Diag-HaloBRCA1A-test-8/Diag-HaloBRCA1A-test-8_ACTTGA_L004_R2_001.pf.clipped_m20.fastq
...
#
export RG="@RG\tID:Sample8_CutA\tPL:ILLUMINA\tSM:Sample8_CutA"


export LOG="$PWD/$0_`date '+%F_%T'`.log"
echo `date` > timeUsedCutA.txt
echo $LOG
